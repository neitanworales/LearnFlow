<?php
require_once './dao/PaqueteEventoDao.php';
require_once './models/PaqueteEvento.php';

class PaqueteEventoController {
    private $dao;

    public function __construct() {
        $this->dao = new PaqueteEventoDao();
    }
